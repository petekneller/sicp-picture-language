...
(facts "map-point-user-to-panel-space can scale its input"
       (let [map-fn (partial map-point-user-to-frame-space (make-frame origin 200 200))]
...
(facts "map-point-user-to-panel-space can translate its input"
       (let [map-fn (partial map-point-user-to-frame-space (make-frame {:x 50 :y 100} 1000 1000))]
...
(facts "map-point-user-to-panel-space can translate and scale its input"
       (let [map-fn (partial map-point-user-to-frame-space (make-frame {:x 10 :y 15} 500 500))]
